...
def save_results(results: dict, target_dir: str):
    """
...
def load_model(target_dir: str, model: torch.nn.Module, device: torch.device = "mps"):
    """
    ...
    """
    state_dict = torch.load(target_dir, map_location=device)
    model_ = model
